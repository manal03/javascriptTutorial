...
export default function Main() {
  ...
  const ingredData = ingredient.map((ing) => {
    return <li>{ing}</li>;
  });
  function handleSubmitClick(formData) {
  ...
  return (
    <>
      <main>
        <form action={handleSubmitClick} class="formSubmit">
          <input
            type="text"
          ...
          <section className="ingredients-container">
            ...
            {ingredient.length > 3 && (
              <div className="recipe-generator">
                ...
                <button className="getRecipe" onClick={handleIsShown}>
                  Get a recipe
                </button>
              </div>
            )}
